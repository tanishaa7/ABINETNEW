...
def _get_dataset(ds_type, paths, is_training, config, **kwargs):
    ...
    print("max length main.py === ",config.dataset_max_length)
    print("charset path main.py === ",config.dataset_charset_path)
...
def _get_model(config):
    ...
    print("module name main.py === ", module_name)
    print("class name main.py === ", class_name)
    print("max length get mod main.py === ",config.dataset_max_length)
    print("charset path get mod main.py === ",config.dataset_charset_path)
    model = cls(config)
    logging.info(model)
    return model
