...
class BaseVision(Model):
    def __init__(self, config):
        ...
        #here we have hardcoded the num_classes of the character set as 183 for the bengali character set
        #for other character sets either comment the below line or change the value
        #changed by tanisha
        self.charset.num_classes = 183
        self.cls = nn.Linear(self.out_channels, self.charset.num_classes)
        print("charset num classes model_vision.py === ",self.charset.num_classes)
        print("max length model_vision.py === ",self.max_length)
