...
class ImageDataset(Dataset):
    ...
    def __init__(self,
                 ...
                 charset_path: str = 'data/charset_bl.txt',
        ...
        #changed by tanisha
        charset_path = 'data/charset_bl.txt'
        self.max_length = 182
        max_length = 182
        ...
        print("charset.num_classes -- ",self.c)
    ...
    def get(self, idx):
        with self.env.begin(write=False) as txn:
            ...
            try:
                ...
                buf.write(imgbuf)
                buf.seek(0)
                #logging.info(f'GOOD image is found: {self.name}, {idx}, {label}, {len(label)}')
    ...
    def __getitem__(self, idx):
        ...
        #print("THE IMAGE ARE THE FOLLOWINGS:")
